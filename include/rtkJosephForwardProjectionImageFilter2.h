...
SumAlongRay = [](const ThreadIdType itkNotUsed(threadId),
         TOutput &          sumValue,
...
ProjectedValueAccumulation = [](const ThreadIdType itkNotUsed(threadId),
         const TInput &     input,
         TOutput &          output,
...
private:
  ...
  SumAlongRayFunc m_SumAlongRay =
    Functor::SumAlongRay< InputPixelType, OutputPixelType >;
